...
if TYPE_CHECKING:
    from app.domain.trading.models.value_objects import OrderBook, AggressivePrint
...
from app.domain.fabio_ai.services.aggression_scorer import PersistentAggressionScorer
