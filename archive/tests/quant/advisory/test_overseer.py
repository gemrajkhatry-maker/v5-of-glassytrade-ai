...
def _pos():
    sig = Signal.create(
        type=SignalType.BUY, price=100, reason="r", stop_loss=99,
        take_profit=102, timestamp="t0", setup=SetupType.TREND_MODEL,
        source=Source.LLM, metadata={"quant_rr": 2, "confidence": 0.8},
    )
