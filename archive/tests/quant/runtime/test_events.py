...
def _fill():
    sig = Signal.create(
        type=SignalType.BUY, price=100.0, reason="test", stop_loss=99.0,
        take_profit=102.0, timestamp="t1", setup=SetupType.TREND_MODEL,
        source=Source.LLM, metadata={"quant_rr": 2.0, "confidence": 0.7},
    )
