...
| --- | --- | --- |
| exchangeSegmentrequired | enum string | Exchange & segment for which data is to be fetched - here |
| interval
             required | enum integer | Minute intervals in timeframe
            1, 5, 15, 25, 60 |
| securityIdrequired | string | Underlying exchange standard ID for each scrip. Refer here |
| instrument
