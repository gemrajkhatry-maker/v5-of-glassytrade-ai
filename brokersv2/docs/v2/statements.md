...
| Field | Description |
| --- | --- |
| from-daterequired | Date from which Ledger Report is required in format YYYY-MM-DD |
| to-daterequired | Date upto which Ledger Report is required in format YYYY-MM-DD |
...
| Field | Description |
| --- | --- |
| from-daterequired | Date from which Trade History is required in format YYYY-MM-DD |
| to-daterequired | Date upto which Trade History is required in format YYYY-MM-DD |
| pagerequired | Page number of which data is being fetched. Pass 0 as default. |
