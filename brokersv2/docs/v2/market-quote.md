# Market Quote - DhanHQ Ver 2.0 / API Document
...
| Header | Description |
| --- | --- |
| access-tokenrequired | Access Token generated via Dhan |
| client-idrequired | User specific identification generated by Dhan |
...
| --- | --- | --- |
| Exchange Segment ENUMrequired | array | Security ID - can be found here |
