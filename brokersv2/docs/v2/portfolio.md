# Portfolio and Positions - DhanHQ Ver 2.0 / API Document
...
| productType | enum string | Product typeCNC  INTRADAY MARGIN MTF |
...
| toProductType | enum string | Desired product typeCNC  INTRADAY MARGIN |
...
This endpoint only squares off open positions and does not cancel pending orders.
