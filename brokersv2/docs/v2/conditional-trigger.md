...
- You can receive a postback update by providing a Webhook URL (here) while generating the Access Token.
...
- All API orders must come from a whitelisted static IP -
    ...
    [
      Read more
    ](https://madefortrade.in/t/dhanhq-update-safer-participation-of-retail-investors-in-algo-trading-static-ip-mpp-rate-limits/61689)
...
| orders.productType  required | enum | Product typeCNC  INTRADAY MARGIN MTF | CNC |
...
| orders.validity  required | enum | Validity of OrderDAY  IOC | DAY |
...
| orders.productType | enum | Product typeCNC  INTRADAY MARGIN MTF | CNC |
...
| orders.validity | enum | Validity of OrderDAY  IOC | DAY |
